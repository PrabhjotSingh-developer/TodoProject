  ...
  return (
    <>
      ...
      <div className={`flex gap-[48px] items-start   md:py-10 w-[100%] `}>
        ...
        >
          <div
            className={`w-[100%]  md:h-[100%]  md:overflow-y-scroll ${miniState.isOpen?"lg:w-[60%] md:w-[55%]  h-[85vh] overflow-y-scroll md:h-[964px] ":"w-[100%]"} ${mobileBar?"h-[100vh] overflow-hidden hidden":""}}`}
            style={{ transition: ".2s linear all"}}
          >
            <Outlet />
          </div>
          
           <div className={`absolute h-[85vh]  md:sticky md:top-[0%] md:h-[950px]   ${miniState.isOpen?"w-[100%] md:w-[45%] lg:w-[40%]  translate-x-[0]  overflow-hidden ":" w-[100%] translate-x-[100%] md:hidden "}`}  style={{ transition: ".3s linear all"}}>
                {isVisible &&
