...
const SideBar = () => {
  ...
  return (
    <div
      className={`flex justify-center  px-24 flex-col items-center relative z-[5] pt-4 ${theme=== "light" ? "bg-[#EEF6EF] lg:bg-transparent" : "bg-[#2C2C2C] lg:bg-transparent"} `}
    >
      <div className={` w-[118px] h-[118px]`}>
        <img src={profile} alt="" className="w-[100%] h-[100%]" />
      </div>
      <div
        className={`contentBox ${bgColor} w-[100%] flex flex-col items-center absolute top-[60%] z-[-1] pt-[4.5rem] h-[900px] text-font gap-[9px]`}
        style={{ transition: ".3s linear all" }}
      >
        <h2 className="font-normal leading-[20px] text-[15px]">Hey, ABCD</h2>
        <div
          className={`${
            theme === "light" ? "back-color-whitish" : "bg-[#232323]"
          } py-[24px] w-[240px] mainLinks`}
        >
          <ul className="">
            {LinksNames.map((item) => {
              return (
        ...
        <div
          className={`addList  w-[240px] py-[24px] ${
            theme === "light" ? "back-color-whitish" : "bg-[#232323]"
          }`}
        >
        ...
        <div
          className={`chart  flex items-center flex-col w-[236px]   text-font ${
            theme === "light" ? "back-color-whitish" : "bg-[#232323]"
          } ${allTodos.length > 0 ? 'h-[307px]':"h-[150px]"}`}
        >
          <div className="totalTasks flex flex-col w-[100%] px-[8px] py-[16px]  ">
            <div className="flex justify-between items-center w-[100%] ">
              <h3 className="text-14px">All Tasks</h3>
              <span className="w-[16px] h-[16px] bg-[#BDBDBD] rounded-[50%] text-white flex justify-center items-center ">
                i
              </span>
            </div>
            ...
            <div className="mainChart py-4">
              ...
              <div className="labels flex gap-2 items-center mt-2">
                <div className="flex gap-1 items-center">
                  ...
                  <p className="text-[12px] font-normal leading-[9.65px]">
                    Pending
                  </p>
                </div>
                <div className="flex gap-1 items-center">
